...
class TestAPIEndpoints(unittest.TestCase):
    ...
    def test_successful_subscription_details(self):
        ...
        print(response_data)
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response_data.get('recalls'), [{'Category': 'Not Heat Treated - Shelf Stable', 'Class': 'Class 1', 'CloseDate': '2024-03-01', 'CompanyID': 6, 'CompanyTitle': 'Director FSQA &amp; Regulatory Affairs', 'OpenDate': '2024-02-01', 'ProductName': '1-lb. plastic tubs labeled as &quot;Sysco Classic Chicken Flavored Base&quot; with lot code 02673 and packaged in a case labeled as &quot;Sysco Classic BEEF BASE CF&quot; with lot code 02673 represented on the label.', 'Qty': 200, 'Reason': 'Unreported Allergens', 'RecallNum': '003-2024', 'RiskLevel': 'Class I', 'StateName': 'California', 'Type': 'Closed Recall', 'Year': '2024'}, {'Category': 'Heat Treated - Shelf Stable', 'Class': 'Public Health Alert', 'CloseDate': '', 'CompanyID': 7, 'CompanyTitle': 'Pruski’s Market', 'OpenDate': '2023-11-17', 'ProductName': '• 1.75-oz., 2.75-oz., and 8-oz. packages containing “Pruski’s Market Spicy Beef Jerky”  and a “SELL BY” date ranging from 03/21/24 through 05/09/24 represented on the  back of the packages., • 1.75-oz., 2.75-oz., and 8-oz. packages containing “Pruski’s Market Beef Jerky” and a  “SELL BY” date ranging from 03/21/24 through 05/09/24 represented on the back of  the packages., • 1.75-oz, 2.75-oz., and 8-oz. packages containing “Pruski’s Market Turkey Jerky” and a  “SELL BY” date ranging from 03/21/24 through 05/09/24 represented on the back of  the packages., • 3-oz. packages containing “HOOSER CUSTOM MEATS BEEF JERKY MESQUITE  SMOKED” and a “SELL BY” of 04/23/24 represented on the back of the packages., • Packages purchased by weight at the retail counter, containing “Beef Jerky Regular”,  “Spicy Beef Jerky”, or “Turkey Jerky” with Pack Date ranging from 9/21/23 through  11/9/23.', 'Qty': 150, 'Reason': 'Unreported Allergens', 'RecallNum': 'PHA-11172023-01', 'RiskLevel': 'Public Health Alert', 'StateName': 'California', 'Type': 'Public Health Alert', 'Year': ''}], 
                         "Did not match the expected payload!")
